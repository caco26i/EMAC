...
app.config(['$routeProvider', function ($routeProvider) {
  $routeProvider
    ...
    .when("/#", {templateUrl: "partials/inicio.html", controller: "PageCtrl"})
    //niveles
    .when("/niveles", {templateUrl: "partials/niveles.html", controller: "NivelesCtrl"})
    .when("/niveles/:idNivel", {templateUrl: "partials/niveles.html", controller: "NivelesCtrl"})
    .when("/niveles/:idNivel/temas/:idTema?", {templateUrl: "partials/temas.html", controller: "NivelesCtrl"})
    // Pages
    ...
    .when("/temas", {templateUrl: "partials/temas.html", controller: "NivelesCtrl"})
    .when("/registro", {templateUrl: "partials/registro.html", controller: "PageCtrl"})
